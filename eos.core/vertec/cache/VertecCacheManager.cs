namespace eos.core.vertec.cache
{
    ...
    public abstract class VertecKeylessCacheManager<T> : VertecCacheManager<DummyCacheKey, T> where T : class
    {
        public VertecKeylessCacheManager(Configuration configuration, string name): base(configuration, name)
        {
        }
    ...
    public abstract class VertecCacheManager<T, U> where T: class where U: class 
    {
        ...
        {
            return Path.Join(this._configuration.VertecCacheLocation, this.GetFileName(cacheKey));
        }
        ...
        {
            return Directory.GetFiles(this._configuration.VertecCacheLocation)
